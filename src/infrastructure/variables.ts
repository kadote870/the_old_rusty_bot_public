...
export const variable = {
    ...
    insults: ['Nosacz:monkey:', 'Pan maruda niszczyciel dobrej zabawy, pogromca uśmiechów dzieci',
 'Malkontent', 'Mniejszy sprzedawca uranu'],
...
export const dotArt: { gigaChad: string } = {
    gigaChad: `⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⡴⡢⡶⠶⢢⢄
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢰⢏⣺⢿⣿⣾⣹⣷⢡
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢾⣾⣟⠝⠀⠨⠉⢹⡏
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣾⣻⡇⠘⠿⢾⢐⣶⠃
