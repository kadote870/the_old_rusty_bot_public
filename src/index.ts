...
import {LegendRoll} from "./rpg/l5r/roll";
import {LegendDamageOperator} from "./rpg/l5r/fight";
import {BankOperator} from "./rpg/common-elements/bank";
    ...
    if (userRecognize.enabled) {
        ...
        switch (message.content.toLowerCase()) {
            ...
            case 'coin':
                ...
                break
            case 'reward':
                new BotResponse(user, message, `${variable.codeBlock}Nagroda: ${randomNumber(rewardValue.min, rewardValue.max)}${variable.codeBlock}`);
                break
            case ('nieparzyste'):
            case ('nie parzyste'):
