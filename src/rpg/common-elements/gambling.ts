...
const japanese_gambling_game_elements = (): {
   roll1Result: number;
   roll2Result: number;
   checkModulo: number;
} => {
...
export const games: {
   ...
   gambling_odd_number: function (user: any): string {
      // Nieparzyste - Gra w japońskim kasynie 2k6 o zwycięstwie decyduje wcześniejsza deklaracja wyniku rzutu przez gracza: parzyste/nieparzyste
      const roll: {
         roll1Result: number;
         roll2Result: number;
         checkModulo: number;
      } = japanese_gambling_game_elements();
   ...
   gambling_even_number: function (user: any): string {
      // Parzyste - Gra w japońskim kasynie 2k6 o zwycięstwie decyduje wcześniejsza deklaracja wyniku rzutu przez gracza: parzyste/nieparzyste
      const roll: {
         roll1Result: number;
         roll2Result: number;
         checkModulo: number;
