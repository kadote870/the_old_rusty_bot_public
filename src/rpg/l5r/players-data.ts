...
import { CharacterClanEnum, CharacterFamilyEnum, CharacterSchoolEnum } from './data/character-enums';
...
class dataFaker1 extends L5RCharacter {
   constructor() {
      ...
      this.data.player = true;
      this.data.school = CharacterSchoolEnum.StrazDaidoji;
...
export const PLAYERS = async () => {
   return [new TestLegendUser(), new botUser(), new dataFaker1(), new dataFaker2(), new dataFaker3(), new dataFaker4()];
};
