            ...
            switch (message.content.toLowerCase()) {
               case 'warhammer human':
                  new BotResponse(
                     user,
                     message,
                     `${variable.codeBlock}${new Human().printer()}${variable.codeBlock}`
                  );
                  break;
               case 'warhammer elf':
                  new BotResponse(
                     user,
                     message,
                     `${variable.codeBlock}${new Elf().printer()}${variable.codeBlock}`
                  );
                  break;
               case 'warhammer dwarf':
                  new BotResponse(
                     user,
                     message,
                     `${variable.codeBlock}${new Dwarf().printer()}${variable.codeBlock}`
                  );
                  break;
               case 'warhammer halfling':
                  new BotResponse(
                     user,
                     message,
                     `${variable.codeBlock}${new Halfling().printer()}${variable.codeBlock}`
                  );
                  break;
            }
         } else {
